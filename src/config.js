export default {
  ...
  datasources: {
    openformat: {
      ...
      prefix: process.env.OPENFORMAT_PREFIX || "openformat"
    },
    moreinfo: {
      ...
      prefix: process.env.MOREINFO_PREFIX || "moreinfo"
    },
    work: {
      url:
      ...
      prefix: process.env.WORKSERVICE_PREFIX || "workservice"
    },
    redis: {
      host: process.env.REDIS_HOST || "127.0.0.1",
      port: process.env.REDIS_PORT || "6379",
      prefix: process.env.REDIS_PREFIX || "bibdk-api",
